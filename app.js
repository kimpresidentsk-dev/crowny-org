...
async function initTradingViewChart() {
    ...
    try {
        ...
        const candleSeries = chart.addCandlestickSeries({
            upColor: '#CD2E3A',
            downColor: '#5B3B8C',
            borderUpColor: '#CD2E3A',
            borderDownColor: '#5B3B8C',
            wickUpColor: '#CD2E3A',
            wickDownColor: '#5B3B8C',
        });
        ...
        if (mnqContainer) {
            ...
            const mnqCandleSeries = mnqChart.addCandlestickSeries({
                upColor: '#CD2E3A', downColor: '#5B3B8C',
                borderUpColor: '#CD2E3A', borderDownColor: '#5B3B8C',
                wickUpColor: '#CD2E3A', wickDownColor: '#5B3B8C',
            });
...
function updateLiveCandleChart() {
    ...
    if (candles.length > 0) {
        ...
        const volData = candles.map(c => ({
            ...
            color: c.close >= c.open ? '#CD2E3A33' : '#5B3B8C33',
        }));
