...
function applyMASettings() {
    ...
    if (window.ma1Series) window.ma1Series.applyOptions({ color: nqMa1Color, title: nqMa1Name });
    if (window.ma2Series) window.ma2Series.applyOptions({ color: nqMa2Color, title: nqMa2Name });
    if (window.ma3Series) window.ma3Series.applyOptions({ color: nqMa3Color, title: nqMa3Name });
    ...
    if (window.mnqMa1Series) window.mnqMa1Series.applyOptions({ color: mnqMa1Color, title: mnqMa1Name });
    if (window.mnqMa2Series) window.mnqMa2Series.applyOptions({ color: mnqMa2Color, title: mnqMa2Name });
    if (window.mnqMa3Series) window.mnqMa3Series.applyOptions({ color: mnqMa3Color, title: mnqMa3Name });
