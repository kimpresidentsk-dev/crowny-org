...
const BRAIN = (() => {
    ...
    async function init() {
        ...
        container.innerHTML = `
            ...
            <div style="display:grid;gap:0.8rem;margin-bottom:1.5rem;">
                <div onclick="BRAIN.startStage(1)" style="background:linear-gradient(135deg,#667eea,#764ba2);padding:1.2rem;border-radius:12px;color:white;cursor:pointer;">
                ...
                <div onclick="BRAIN.startStage(2)" style="background:linear-gradient(135deg,#f093fb,#f5576c);padding:1.2rem;border-radius:12px;color:white;cursor:pointer;">
                    <div style="display:flex;justify-content:space-between;align-items:center;">
                        <div>
                ...
                <div onclick="BRAIN.startStage(3)" style="background:linear-gradient(135deg,#4facfe,#00f2fe);padding:1.2rem;border-radius:12px;color:white;cursor:pointer;">
                    <div style="display:flex;justify-content:space-between;align-items:center;">
                        <div>
        ...
        container.innerHTML = `
            <div style="margin-bottom:1rem;">
                ...
                <div style="background:#e0e0e0;border-radius:10px;height:6px;">
                    <div style="background:linear-gradient(90deg,#667eea,#764ba2);height:100%;width:${progress}%;border-radius:10px;transition:width 0.3s;"></div>
                </div>
            </div>
                ...
                <div style="display:grid;gap:0.6rem;">
                    ${q.a.map((a, i) => `
                        <button onclick="BRAIN.answer('${a.t}')" 
                            ...
                            onmouseenter="this.style.borderColor='#667eea';this.style.background='#f0f0ff'"
    ...
    async function finishStage1() {
        ...
        container.innerHTML = `
            ...
            <div style="background:${temp.gradient};border-radius:12px;padding:1.2rem;color:white;margin-bottom:1rem;">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:0.5rem;">
                <button onclick="BRAIN.startStage(2)" style="padding:0.8rem;border:none;border-radius:10px;background:linear-gradient(135deg,#f093fb,#f5576c);color:white;font-weight:700;cursor:pointer;">🔮 2단계 진행</button>
        ...
        container.innerHTML = `
            <div style="text-align:center;padding:2rem;">
                ...
                <button onclick="BRAIN.startAIEnneagram()" 
                    style="margin-top:1.5rem;padding:1rem 2rem;border:none;border-radius:12px;background:linear-gradient(135deg,#f093fb,#f5576c);color:white;font-weight:700;cursor:pointer;font-size:1rem;">
                    ✨ 크라우니걸과 대화 시작
                </button>
                <br>
    ...
    async function startAIEnneagram() {
        ...
        container.innerHTML = `
            ...
            <div style="display:flex;gap:0.5rem;">
                ...
                <button onclick="BRAIN.sendChat()" style="padding:0.8rem 1.2rem;border:none;border-radius:10px;background:linear-gradient(135deg,#f093fb,#f5576c);color:white;font-weight:700;cursor:pointer;">➤</button>
            </div>
        `;
        // AI 첫 질문
