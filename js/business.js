            ...
            snap.forEach(doc => {
                ...
                card.innerHTML = `
                    ...
                    <div style="margin-top:0.8rem;background:var(--bg,#0a0a1a);border-radius:4px;height:6px;overflow:hidden;">
                        <div style="height:100%;background:var(--gold,#D4AF37);width:${Math.min(100, (d.investmentCurrent/d.investmentGoal)*100)}%;border-radius:4px;"></div>
                    </div>
                ...
                card.innerHTML = `
                    ...
                    <div style="padding:1rem;">
                        ...
                        <div style="display:flex;justify-content:space-between;font-size:0.75rem;">
                            ...
                            <strong style="color:var(--gold,#D4AF37);">${progress}%</strong>
                        </div>
    ...
    window.showCampaignDetail = function(id, data) {
        ...
        content.innerHTML = `
            ...
            <div style="background:#f0f0f0;border-radius:6px;height:10px;overflow:hidden;margin-bottom:0.5rem;">
                <div style="height:100%;background:${progress >= 100 ? '#4CAF50' : '#D4AF37'};width:${progress}%;border-radius:6px;"></div>
            </div>
